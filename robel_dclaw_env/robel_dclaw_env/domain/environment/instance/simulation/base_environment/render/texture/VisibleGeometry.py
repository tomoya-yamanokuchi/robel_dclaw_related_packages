...
class VisibleGeometry:
    ...
    def get_task_relevant_grouped_visible_geometries(self):
        ...
        task_relevant_visible_geoms = self._get_task_relevant_visible_geoms(all_visible_geoms) # objectのまとめるところ
    ...
    def _grouping_task_relevant_visible_geoms(self,
        ...
        '''
            Domin Randomizationをグループ単位で行いたい場合に使う
        '''
