...
from .PushingStateFactory import PushingStateFactory
from task_space.end_effector_2d import BiasedEndEffectorPosition_2D_Plane
from .PushingCanonicalRGB import PushingCanonicalRGB
from .get_object_geom_names import get_object_geom_names


class PushingSimulationEnvironment(AbstractEnvironment):
    def __init__(self, config, use_render=True):
        self.env_name               = "sim_pushing"
        self.canonical_rgb_manager  = PushingCanonicalRGB()
        # ----
    ...
    def set_model_file(self, xml_str: str):
    ...
    def load_model(self):
        ...
        # self.model             = self.base_env.load_model_from_xml(self.xml_str)
        ...
        self.getState          = GetState(self.base_env.sim, PushingStateFactory, self.task_space_transformer)
