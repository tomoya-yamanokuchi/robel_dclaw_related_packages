...
class PushingStateFactory:
    ...
    @staticmethod
    def create_for_get_state(task_space_position, end_effector_position, robot_position, robot_velocity, object_rotation, object_position, object_velocity, time, act, udd_state):
        return StateDict(
